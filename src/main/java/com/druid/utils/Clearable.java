...
/**
 * This interface implements a method that has the ability to clear a <code>TextField</code> through
 * a handy shortcut.
 */
public class Clearable {
   ...
   * @return An <code>EventHandler</code> that must be consumed by the provided <code>TextField
   *     </code>.
   */
