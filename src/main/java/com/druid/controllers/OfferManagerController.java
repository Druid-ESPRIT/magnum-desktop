...
public class OfferManagerController implements Initializable {
    ...
    List<Offer> offers = o_svc.getOffersByUser(connectedUser.getID());
    @FXML
    ...
    public AnchorPane getOfferPane() {
        return offerPane;
    }

    public void setOfferPane(AnchorPane offerPane) {
        ...
        if (offers.size() > 0) {
            ...
            myListener = new MyListener() {
                ...
                public void onClickListener(Offer offer) {
                    ...
                    soldcount.setText(String.valueOf(or.getOrderCount(Integer.parseInt(getid.getText()))));
        ...
        addbutton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                ...
                if (option.isPresent() && option.get() == ButtonType.OK) {
                    Offer o = new Offer(connectedUser.getID(), Float.parseFloat(tfprice.getText()), tfdesc.getText(), filechosen.getText());
                    o_svc.updateOffer(o, Integer.parseInt(getid.getText()));
                    refreshData();
                    loadData(o_svc.getOffersByUser(connectedUser.getID()));
                    anchorPane2.setVisible(false);
                }
            }
        });
        ...
        addbutton1.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                ...
                if (option.isPresent() && option.get() == ButtonType.OK) {
                    Alert alert = new Alert(Alert.AlertType.CONFIRMATION);
                    alert.showAndWait();
                    Offer o = new Offer(connectedUser.getID(), Float.parseFloat(tfprice1.getText()), tfdesc1.getText(), filechosen1.getText());
                    o_svc.addOffer(o);
                    tfprice1.setText("");
                    tfdesc1.setText("");
                    filechosen1.setText("");
