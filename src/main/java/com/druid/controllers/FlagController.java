...
public class FlagController implements Initializable {
    ...
    @FXML
    private RadioButton harassment;
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        harassment.selectedProperty().addListener(new ChangeListener<Boolean>() {
            @Override
        ...
        spam.selectedProperty().addListener(new ChangeListener<Boolean>() {
            @Override
            public void changed(ObservableValue<? extends Boolean> observableValue, Boolean oldValue, Boolean newValue) {
                if (newValue) {
        ...
        violence.selectedProperty().addListener(new ChangeListener<Boolean>() {
            @Override
            public void changed(ObservableValue<? extends Boolean> observableValue, Boolean oldValue, Boolean newValue) {
                if (newValue) {
                    spam.setSelected(false);
