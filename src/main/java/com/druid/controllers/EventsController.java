...
public class EventsController implements Initializable {
    ...
    @FXML
    public JFXButton total_income;
    @FXML
    public JFXButton list_events_back;
    @FXML
    public JFXButton add_event_back;
    @FXML
    public JFXButton add_event_back1;
    @FXML
    ...
    public void Stats(MouseEvent mouseEvent) {
        ...
        total_income.setText("Total Income From all Events : "+String.valueOf(eventService.totalIncome(connectedUser.getUser().getID()))+" DT");
