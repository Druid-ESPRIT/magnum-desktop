...
public class Item_BackController implements Initializable {
    ...
    @FXML
    private JFXButton show_reviews_btn;
    ...
    private void Update(ActionEvent event) {
        ...
        Alert alert = new Alert(Alert.AlertType.CONFIRMATION, "Are you sure you want to update this event ?", ButtonType.YES, ButtonType.NO);
        alert.showAndWait();
    ...
    private void Delete(ActionEvent event) {
        Alert alert = new Alert(Alert.AlertType.CONFIRMATION, "Are you sure you want to cancel this event ?", ButtonType.YES, ButtonType.NO);
        alert.showAndWait();
