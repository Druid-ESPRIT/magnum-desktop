...
public class PlaceOrderController implements Initializable {
    ...
    void PayClicked(ActionEvent event) {
        Stripe.apiKey = "sk_test_51KUO54LURk8bHQH66NOA9MpsReXKIXeXkjRe76TuRYFEhjeWw4aFTG1OLaM0oYe62iZFrcGq4Q1kYDQ9ZjNVQeue00pExVMjwm"; // add your api key
        ...
        try {
            customer = Customer.retrieve("cus_LGIbSsLqCcbKfg");//change the customer id or use to get customer by id.
        } catch (StripeException e) {
            e.printStackTrace();
        }
