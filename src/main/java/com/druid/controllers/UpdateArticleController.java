...
public class UpdateArticleController implements Initializable {
  ...
  @FXML private TextField contentUp;
  @FXML private TextField AuthorUp;
  @FXML private TextField urlUp;
  ...
  @FXML private Text authorctrl;
  @FXML private Text contentctrl;
  @FXML private Text urlctrl;

  @FXML private Text titlectrl;
  ...
  public void initialize(URL url, ResourceBundle rb) {
    ...
    AuthorUp.setText(connectedUser.getUsername());
    AuthorUp.setDisable(true);
  }
  ...
  private void update(ActionEvent event) throws IOException {
   ...
   /* List<Podcaster> podcasters = ps.getPodcasters();
    ...
    if (!titleUp.getText().equals("")) {
      ...
      /*if (podcaster == null) alert(authorctrl, "invalid author Name");
      valid = false;*/
    }
    if (contentUp.getText().equals("")) {
