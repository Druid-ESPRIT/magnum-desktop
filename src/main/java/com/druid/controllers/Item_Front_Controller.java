...
public class Item_Front_Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        javafx.scene.image.Image image = new Image("http://127.0.0.1/uploads/"+this.event.getImage(),true);
        ...
        if (e.getStatus().equals(EventStatus.FINISHED)) {
            ...
            }else
            {
                ...
                }else
                {
                    ...
                    Alert alert = new Alert(Alert.AlertType.CONFIRMATION, "Review Updated !", ButtonType.OK);
                    alert.showAndWait();
                }
            }
            ...
            if(eventService.userParticipation(e, u)){
                ...
                participer.setOnAction(event1 -> {
                    Mail.send(connectedUser.getUser().getEmail(),"Event "+this.event.getName()+" Ticket",
