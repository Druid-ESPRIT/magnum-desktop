...
public class Item_Front_Controller implements Initializable {
  ...
  @FXML private Label event_date;

  @FXML private Label event_description;

  @FXML private Label event_location;

  @FXML private Label event_location_label;

  @FXML private Label event_name;

  @FXML private Label event_price;

  @FXML private Label event_status;

  @FXML private JFXButton participer;

  @FXML private ImageView event_image;

  @FXML private Label podcaster_name;
  ...
  public void initialize(URL url, ResourceBundle rb) {
    ...
    javafx.scene.image.Image image =
        new Image("http://127.0.0.1:8000/uploads/" + this.event.getImage(), true);
      ...
      if (eventService.userParticipation(e, u)) {
        ...
        participer.setOnAction(
            event1 -> {
              ...
              try {
                Mail.sendAttachement(
                    connectedUser.getUser().getEmail(),
                    "Event " + this.event.getName() + " Ticket",
                    "Thank you for your purchase\n"
                        ...
                        + connectedUser.getUser().getEmail()
                        + "\n"
                        + "This is a Confirmation Email for participating in Event : "
                        + this.event.getName()
                        + "\n"
                        + "Please Bring and Show this email as a recipient when attending the Event"
