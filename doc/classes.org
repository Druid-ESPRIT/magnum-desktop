...
to stop the re-uploading of already existing audio files (podcasts) within the database.
...
1. Discover page: An interface that presents a curated list of podcasts to the user
sorted by their category.

2. XML Parser: RSS is at the backbone of the podcasting industry; RSS speaks XML.
